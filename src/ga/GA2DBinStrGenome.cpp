...
---------------------------------------------------------------------------- */
GA2DBinaryStringGenome::GA2DBinaryStringGenome(unsigned int width, unsigned int height, GAGenome::Evaluator f, void *u)
    : GABinaryString(width * height),
      GAGenome(DEFAULT_2DBINSTR_INITIALIZER, DEFAULT_2DBINSTR_MUTATOR, DEFAULT_2DBINSTR_COMPARATOR)
{
    evaluator(f);
    userData(u);
...
GA2DBinaryStringGenome::GA2DBinaryStringGenome(const GA2DBinaryStringGenome &orig)
...
void GA2DBinaryStringGenome::copy(const GAGenome &orig)
{
    if (&orig == this)
        return;
    const GA2DBinaryStringGenome *c = DYN_CAST(const GA2DBinaryStringGenome *, &orig);
    if (c) {
        GAGenome::copy(*c);
...
int GA2DBinaryStringGenome::resizeBehaviour(Dimension which, unsigned int lower, unsigned int upper)
{
    if (upper < lower) {
...
void GA2DBinaryStringGenome::copy(const GA2DBinaryStringGenome &orig, unsigned int r, unsigned int s, unsigned int x,
...
void GA2DBinaryStringGenome::set(unsigned int x, unsigned int y, unsigned int w, unsigned int h)
{
    if (x + w > nx)
        w = nx - x;
    if (y + h > ny)
...
void GA2DBinaryStringGenome::unset(unsigned int x, unsigned int y, unsigned int w, unsigned int h)
{
    if (x + w > nx)
        w = nx - x;
    if (y + h > ny)
...
void GA2DBinaryStringGenome::randomize(unsigned int x, unsigned int y, unsigned int w, unsigned int h)
{
    if (x + w > nx)
        w = nx - x;
    if (y + h > ny)
...
void GA2DBinaryStringGenome::move(unsigned int x, unsigned int y, unsigned int srcx, unsigned int srcy, unsigned int w,
                                  unsigned int h)
{
    if (srcx + w > nx)
        w = nx - srcx;
...
int GA2DBinaryStringGenome::equal(const GA2DBinaryStringGenome &orig, unsigned int x, unsigned int y, unsigned int srcx,
                                  unsigned int srcy, unsigned int w, unsigned int h) const
{
    unsigned int eq = 0;
    for (unsigned int j = 0; j < h; j++)
...
{
    const GA2DBinaryStringGenome &sis = DYN_CAST(const GA2DBinaryStringGenome &, a);
    const GA2DBinaryStringGenome &bro = DYN_CAST(const GA2DBinaryStringGenome &, b);
...
int GA2DBinaryStringGenome::UniformCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA2DBinaryStringGenome &mom = DYN_CAST(const GA2DBinaryStringGenome &, p1);
    const GA2DBinaryStringGenome &dad = DYN_CAST(const GA2DBinaryStringGenome &, p2);
    ...
    if (c1 && c2) {
        ...
        GA2DBinaryStringGenome &sis =
            (c1 ? DYN_CAST(GA2DBinaryStringGenome &, *c1) : DYN_CAST(GA2DBinaryStringGenome &, *c2));
...
int GA2DBinaryStringGenome::OnePointCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA2DBinaryStringGenome &mom = DYN_CAST(const GA2DBinaryStringGenome &, p1);
    const GA2DBinaryStringGenome &dad = DYN_CAST(const GA2DBinaryStringGenome &, p2);
...
int GA2DBinaryStringGenome::EvenOddCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA2DBinaryStringGenome &mom = DYN_CAST(const GA2DBinaryStringGenome &, p1);
    const GA2DBinaryStringGenome &dad = DYN_CAST(const GA2DBinaryStringGenome &, p2);
