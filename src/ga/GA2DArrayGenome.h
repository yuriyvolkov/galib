...
class GA2DArrayGenome : public GAArray<T>, public GAGenome
{
  ...
  public:
    GA2DArrayGenome(unsigned int x, unsigned int y, GAGenome::Evaluator f = (GAGenome::Evaluator)0, void* u = (void*)0);
    ...
    void copy(const GA2DArrayGenome&, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int,
              unsigned int);
...
class GA2DArrayAlleleGenome : public GA2DArrayGenome<T>
{
  ...
  public:
    GA2DArrayAlleleGenome(unsigned int x, unsigned int y, const GAAlleleSet<T>& a,
                          GAGenome::Evaluator f = (GAGenome::Evaluator)0, void* u = (void*)0);
    GA2DArrayAlleleGenome(unsigned int x, unsigned int y, const GAAlleleSetArray<T>& a,
                          GAGenome::Evaluator f = (GAGenome::Evaluator)0, void* u = (void*)0);
...
---------------------------------------------------------------------------- */
template <class T>
const char *GA2DArrayGenome<T>::className() const
{
    return "GA2DArrayGenome";
}
template <class T>
int GA2DArrayGenome<T>::classID() const
{
    return GAID::ArrayGenome2D;
}

template <class T>
GA2DArrayGenome<T>::GA2DArrayGenome(unsigned int width, unsigned int height, GAGenome::Evaluator f, void *u)
        : GAArray<T>(width * height),
          GAGenome(DEFAULT_2DARRAY_INITIALIZER, DEFAULT_2DARRAY_MUTATOR, DEFAULT_2DARRAY_COMPARATOR)
{
    evaluator(f);
    userData(u);
...
template <class T>
void GA2DArrayGenome<T>::copy(const GAGenome &orig)
{
    if (&orig == this)
        return;
...
template <class T>
int GA2DArrayGenome<T>::resize(int w, int h)
{
...
#ifdef GALIB_USE_STREAMS
template <class T>
int GA2DArrayGenome<T>::read(STD_ISTREAM &)
{
...
template <class T>
int GA2DArrayGenome<T>::write(STD_OSTREAM &os) const
{
    for (unsigned int j = 0; j < ny; j++) {
        for (unsigned int i = 0; i < nx; i++) {
            os << gene(i, j) << " ";
...
template <class T>
int GA2DArrayGenome<T>::resizeBehaviour(GAGenome::Dimension which, unsigned int lower, unsigned int upper)
{
    if (upper < lower) {
...
template <class T>
void GA2DArrayGenome<T>::copy(const GA2DArrayGenome<T> &orig, unsigned int r, unsigned int s, unsigned int x,
...
template <class T>
int GA2DArrayGenome<T>::equal(const GAGenome &c) const
{
    if (this == &c)
        return 1;
...
---------------------------------------------------------------------------- */
template <class T>
const char *GA2DArrayAlleleGenome<T>::className() const
{
    return "GA2DArrayAlleleGenome";
}
template <class T>
int GA2DArrayAlleleGenome<T>::classID() const
{
    return GAID::ArrayAlleleGenome2D;
}

template <class T>
GA2DArrayAlleleGenome<T>::GA2DArrayAlleleGenome(unsigned int width, unsigned int height, const GAAlleleSet<T> &s,
...
template <class T>
GA2DArrayAlleleGenome<T>::GA2DArrayAlleleGenome(unsigned int width, unsigned int height, const GAAlleleSetArray<T> &sa,
                                                GAGenome::Evaluator f, void *u)
        : GA2DArrayGenome<T>(width, height, f, u)
{
    naset = sa.size();
...
template <class T>
GA2DArrayAlleleGenome<T>::GA2DArrayAlleleGenome(const GA2DArrayAlleleGenome<T> &orig)
...
template <class T>
void GA2DArrayAlleleGenome<T>::copy(const GAGenome &orig)
{
    if (&orig == this)
        return;
    const GA2DArrayAlleleGenome<T> *c = DYN_CAST(const GA2DArrayAlleleGenome<T> *, &orig);
    if (c) {
...
template <class T>
int GA2DArrayAlleleGenome<T>::resize(int x, int y)
{
...
#ifdef GALIB_USE_STREAMS
template <class T>
int GA2DArrayAlleleGenome<T>::read(STD_ISTREAM &is)
{
    return GA2DArrayGenome<T>::read(is);
}

template <class T>
int GA2DArrayAlleleGenome<T>::write(STD_OSTREAM &os) const
{
...
template <class T>
int GA2DArrayAlleleGenome<T>::equal(const GAGenome &c) const
{
...
{
    GA2DArrayAlleleGenome<ARRAY_TYPE> &child = DYN_CAST(GA2DArrayAlleleGenome<ARRAY_TYPE> &, c);
...
template <class ARRAY_TYPE>
float GA2DArrayGenome<ARRAY_TYPE>::ElementComparator(const GAGenome &a, const GAGenome &b)
{
    const GA2DArrayGenome<ARRAY_TYPE> &sis = DYN_CAST(const GA2DArrayGenome<ARRAY_TYPE> &, a);
    const GA2DArrayGenome<ARRAY_TYPE> &bro = DYN_CAST(const GA2DArrayGenome<ARRAY_TYPE> &, b);
...
template <class T>
int GA2DArrayGenome<T>::UniformCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    ...
    if (c1 && c2) {
        ...
        if (sis.width() == bro.width() && sis.height() == bro.height() && mom.width() == dad.width() &&
            mom.height() == dad.height() && sis.width() == mom.width() && sis.height() == mom.height()) {
        ...
        if (mom.width() == dad.width() && mom.height() == dad.height() && sis.width() == mom.width() &&
...
template <class T>
int GA2DArrayGenome<T>::OnePointCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA2DArrayGenome<T> &mom = DYN_CAST(const GA2DArrayGenome<T> &, p1);
    const GA2DArrayGenome<T> &dad = DYN_CAST(const GA2DArrayGenome<T> &, p2);
...
template <class T>
int GA2DArrayGenome<T>::EvenOddCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA2DArrayGenome<T> &mom = DYN_CAST(const GA2DArrayGenome<T> &, p1);
    const GA2DArrayGenome<T> &dad = DYN_CAST(const GA2DArrayGenome<T> &, p2);
