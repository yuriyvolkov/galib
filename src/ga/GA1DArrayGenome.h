...
class GA1DArrayGenome : public GAArray<T>, public GAGenome
{
  public:
    ...
    static int PartialMatchCrossover(const GAGenome&, const GAGenome&, GAGenome*, GAGenome*);
    static int OrderCrossover(const GAGenome&, const GAGenome&, GAGenome*, GAGenome*);
    static int CycleCrossover(const GAGenome&, const GAGenome&, GAGenome*, GAGenome*);
...
class GA1DArrayAlleleGenome : public GA1DArrayGenome<T>
{
  ...
  public:
    GA1DArrayAlleleGenome(unsigned int x, const GAAlleleSet<T>& a, GAGenome::Evaluator f = (GAGenome::Evaluator)0,
                          void* u = (void*)0);
...
template <class T>
int GA1DArrayIsHole(const GA1DArrayGenome<T> &, const GA1DArrayGenome<T> &, int, int, int);

/* ----------------------------------------------------------------------------
1DArrayGenome
---------------------------------------------------------------------------- */
template <class T>
const char *GA1DArrayGenome<T>::className() const
{
    return "GA1DArrayGenome";
}
template <class T>
int GA1DArrayGenome<T>::classID() const
{
...
template <class T>
GA1DArrayGenome<T>::GA1DArrayGenome(unsigned int length, GAGenome::Evaluator f, void *u)
        : GAArray<T>(length), GAGenome(DEFAULT_1DARRAY_INITIALIZER, DEFAULT_1DARRAY_MUTATOR, DEFAULT_1DARRAY_COMPARATOR)
{
    evaluator(f);
    userData(u);
    nx = minX = maxX = length;
...
template <class T>
void GA1DArrayGenome<T>::copy(const GAGenome &orig)
{
    if (&orig == this)
        return;
...
template <class T>
int GA1DArrayGenome<T>::resize(int len)
{
...
template <class T>
int GA1DArrayGenome<T>::resizeBehaviour() const
{
    int val = maxX;
    if (maxX == minX)
        val = FIXED_SIZE;
...
template <class T>
int GA1DArrayGenome<T>::equal(const GAGenome &c) const
{
...
---------------------------------------------------------------------------- */
template <class T>
const char *GA1DArrayAlleleGenome<T>::className() const
{
    return "GA1DArrayAlleleGenome";
}
template <class T>
int GA1DArrayAlleleGenome<T>::classID() const
{
    return GAID::ArrayAlleleGenome;
}

template <class T>
GA1DArrayAlleleGenome<T>::GA1DArrayAlleleGenome(unsigned int length, const GAAlleleSet<T> &s, GAGenome::Evaluator f,
                                                void *u)
        : GA1DArrayGenome<T>(length, f, u)
{
    ...
    GAGenome::comparator(GA1DArrayAlleleGenome<T>::DEFAULT_1DARRAY_ALLELE_COMPARATOR);
    GAGenome::crossover(GA1DArrayAlleleGenome<T>::DEFAULT_1DARRAY_ALLELE_CROSSOVER);
}

template <class T>
GA1DArrayAlleleGenome<T>::GA1DArrayAlleleGenome(const GAAlleleSetArray<T> &sa, GAGenome::Evaluator f, void *u)
...
template <class T>
GA1DArrayAlleleGenome<T>::GA1DArrayAlleleGenome(const GA1DArrayAlleleGenome<T> &orig)
...
template <class T>
void GA1DArrayAlleleGenome<T>::copy(const GAGenome &orig)
{
    if (&orig == this)
        return;
...
#ifdef GALIB_USE_STREAMS
template <class T>
int GA1DArrayAlleleGenome<T>::read(STD_ISTREAM &is)
{
    return GA1DArrayGenome<T>::read(is);
}

template <class T>
int GA1DArrayAlleleGenome<T>::write(STD_OSTREAM &os) const
{
...
template <class T>
int GA1DArrayAlleleGenome<T>::equal(const GAGenome &c) const
{
...
{
    GA1DArrayAlleleGenome<ARRAY_TYPE> &child = DYN_CAST(GA1DArrayAlleleGenome<ARRAY_TYPE> &, c);
...
template <class ARRAY_TYPE>
float GA1DArrayGenome<ARRAY_TYPE>::ElementComparator(const GAGenome &a, const GAGenome &b)
{
    const GA1DArrayGenome<ARRAY_TYPE> &sis = DYN_CAST(const GA1DArrayGenome<ARRAY_TYPE> &, a);
    const GA1DArrayGenome<ARRAY_TYPE> &bro = DYN_CAST(const GA1DArrayGenome<ARRAY_TYPE> &, b);
...
template <class T>
int GA1DArrayGenome<T>::UniformCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    ...
    if (c1 && c2) {
        ...
        if (sis.length() == bro.length() && mom.length() == dad.length() && sis.length() == mom.length()) {
...
template <class T>
int GA1DArrayGenome<T>::OnePointCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA1DArrayGenome<T> &mom = DYN_CAST(const GA1DArrayGenome<T> &, p1);
    const GA1DArrayGenome<T> &dad = DYN_CAST(const GA1DArrayGenome<T> &, p2);
    ...
    if (c1 && c2) {
        ...
        if (sis.resizeBehaviour() == GAGenome::FIXED_SIZE && bro.resizeBehaviour() == GAGenome::FIXED_SIZE) {
            if (mom.length() != dad.length() || sis.length() != bro.length() || sis.length() != mom.length()) {
        ...
        } else if (sis.resizeBehaviour() == GAGenome::FIXED_SIZE || bro.resizeBehaviour() == GAGenome::FIXED_SIZE) {
...
template <class T>
int GA1DArrayGenome<T>::TwoPointCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA1DArrayGenome<T> &mom = DYN_CAST(const GA1DArrayGenome<T> &, p1);
    const GA1DArrayGenome<T> &dad = DYN_CAST(const GA1DArrayGenome<T> &, p2);
...
template <class T>
int GA1DArrayGenome<T>::EvenOddCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA1DArrayGenome<T> &mom = DYN_CAST(const GA1DArrayGenome<T> &, p1);
    const GA1DArrayGenome<T> &dad = DYN_CAST(const GA1DArrayGenome<T> &, p2);
...
template <class T>
int GA1DArrayGenome<T>::PartialMatchCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA1DArrayGenome<T> &mom = DYN_CAST(const GA1DArrayGenome<T> &, p1);
    const GA1DArrayGenome<T> &dad = DYN_CAST(const GA1DArrayGenome<T> &, p2);
...
template <class T>
int GA1DArrayIsHole(const GA1DArrayGenome<T> &c, const GA1DArrayGenome<T> &dad, int index, int a, int b)
{
    for (int i = a; i < b; i++)
...
template <class T>
int GA1DArrayGenome<T>::OrderCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA1DArrayGenome<T> &mom = DYN_CAST(const GA1DArrayGenome<T> &, p1);
    const GA1DArrayGenome<T> &dad = DYN_CAST(const GA1DArrayGenome<T> &, p2);
...
template <class T>
int GA1DArrayGenome<T>::CycleCrossover(const GAGenome &p1, const GAGenome &p2, GAGenome *c1, GAGenome *c2)
{
    const GA1DArrayGenome<T> &mom = DYN_CAST(const GA1DArrayGenome<T> &, p1);
    const GA1DArrayGenome<T> &dad = DYN_CAST(const GA1DArrayGenome<T> &, p2);
