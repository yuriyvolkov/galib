...
static const char *__gaErrStr[] = { "error reading from file: ",
...
void GAErr(const GASourceLocator loc, const char *clss, const char *func, const char *msg1, const char *msg2,
           const char *msg3)
{
    gaErrMsg[0] = '\0';
...
void GAErr(const GASourceLocator loc, const char *clss, const char *func, GAErrorIndex i, const char *msg2,
           const char *msg3)
{
    gaErrMsg[0] = '\0';
    strcat(gaErrMsg, clss);
...
void GAErr(const GASourceLocator loc, const char *func, GAErrorIndex i, const char *msg2, const char *msg3)
{
    gaErrMsg[0] = '\0';
    strcat(gaErrMsg, func);
    strcat(gaErrMsg, ":\n  ");
...
void GAReportErrors(GABoolean flag) { __gaErrFlag = flag; }

#ifdef GALIB_USE_STREAMS
void GASetErrorStream(STD_OSTREAM &s) { __gaErrStream = &s; }
#endif
