...
class GA3DBinaryStringGenome : public GABinaryString, public GAGenome
{
  ...
  public:
    ...
    short gene(unsigned int x, unsigned int y, unsigned int z) const { return bit(z * ny * nx + y * nx + x); }
    ...
    void copy(const GA3DBinaryStringGenome &, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int,
              unsigned int, unsigned int, unsigned int, unsigned int);
    int equal(const GA3DBinaryStringGenome &, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int,
              unsigned int, unsigned int, unsigned int, unsigned int) const;
    void set(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int);
    void unset(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int);
    void move(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int,
              unsigned int, unsigned int);
    void randomize(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int);
