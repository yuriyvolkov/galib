...
class GARouletteWheelSelector : public GASelectionScheme
{
  public:
    ...
    GARouletteWheelSelector(int w = GASelectionScheme::SCALED) : GASelectionScheme(w)
    {
        psum = (float*)0;
        n = 0;
    }
...
class GATournamentSelector : public GARouletteWheelSelector
{
  public:
    ...
    GATournamentSelector(int w = GASelectionScheme::SCALED) : GARouletteWheelSelector(w) {}
    ...
    virtual GASelectionScheme* clone() const { return new GATournamentSelector; }
    virtual GAGenome& select() const;
};
#endif
