...
class GABin2DecPhenotype
{
  public:
    ...
    GABin2DecPhenotype(const GABin2DecPhenotype &p) : core(new GABin2DecPhenotypeCore(*(p.core))) {}
...
inline int operator==(const GABin2DecPhenotype &a, const GABin2DecPhenotype &b) { return a.equal(b); }

inline int operator!=(const GABin2DecPhenotype &a, const GABin2DecPhenotype &b) { return (a.equal(b) ? 0 : 1); }
...
class GABin2DecGenome : public GA1DBinaryStringGenome
{
  ...
  public:
    GABin2DecGenome(const GABin2DecPhenotype &p, GAGenome::Evaluator f = (GAGenome::Evaluator)0, void *u = (void *)0)
    ...
    GABin2DecGenome(const GABin2DecGenome &orig) : GA1DBinaryStringGenome(orig.sz)
    {
