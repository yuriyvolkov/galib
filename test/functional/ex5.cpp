...
class CompositeGenome : public GAGenome
{
  public:
    ...
    static int CompositeCrossover(const GAGenome&, const GAGenome&, GAGenome*, GAGenome*);

  public:
    CompositeGenome(int, int, GABin2DecPhenotype&, GAGenome::Evaluator f = NULL, void* u = NULL);
...
CompositeGenome::CompositeGenome(int element, int bond, GABin2DecPhenotype& p, GAGenome::Evaluator f, void* u)
...
GAGenome* CompositeGenome::clone(GAGenome::CloneMethod) const { return new CompositeGenome(*this); }
...
int CompositeGenome::CompositeCrossover(const GAGenome& a, const GAGenome& b, GAGenome* c, GAGenome* d)
{
