...
int main(int argc, char *argv[])
{
    ...
    data.picture_genome = new GA2DBinaryStringGenome(data.width, data.height, PictureObjective, (void *)&data);
    data.numbers_genome = new GABin2DecGenome(map, NumbersObjective, (void *)&data);
...
float PictureObjective(GAGenome &c)
{
...
float NumbersObjective(GAGenome &c)
{
