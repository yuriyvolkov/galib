...
int main(int argc, char **argv)
{
    ...
    if (dochisq) {
        ...
        for (ii = 0; ii < 10; ii++) {
            ...
            for (i = 0; i < RCHI; i++)
                chisq += ((double)f[i] - (double)NCHI / (double)RCHI) * ((double)f[i] - (double)NCHI / (double)RCHI);
    ...
    if (dobnds) {
        ...
        if (err)
            cout << " " << err << " values out of bounds.\n";
        else
            cout << "ok\n";
        cout.flush();

        cerr << "  " << NUM_CHECKS << "  GARandomInt(0,3)...\n";
        cout << "GARandomInt(0,3) ...";
        cout.flush();
        err = 0;
        for (ii = 0; ii < NUM_CHECKS; ii++) {
        ...
        if (err)
            cout << " " << err << " values out of bounds (" << lastf << ").\n";
        else
            cout << "ok\n";
        cout.flush();

        cerr << "  " << NUM_CHECKS << "  GARandomFloat(0,3)...\n";
        cout << "GARandomFloat(0,3) ...";
        cout.flush();
        err = 0;
        for (ii = 0; ii < NUM_CHECKS; ii++) {
        ...
        if (err)
            cout << " " << err << " values out of bounds (" << lastd << ").\n";
        else
            cout << "ok\n";
        cout.flush();

        cerr << "  " << NUM_CHECKS << "  GARandomDouble(0,3)...\n";
        cout << "GARandomDouble(0,3) ...";
        cout.flush();
        err = 0;
        for (ii = 0; ii < NUM_CHECKS; ii++) {
